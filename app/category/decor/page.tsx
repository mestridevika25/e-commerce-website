...
export default function DecorCategoryPage() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 125,
      image: "/handwoven-wall-tapestry.jpg",
      rating: 4.8,
      reviews: 89,
      category: "Textiles",
    },
    ...
    },
    {
      ...
      price: 45,
      image: "/macrame-plant-hanger.png",
      rating: 4.6,
      reviews: 156,
      isNew: true,
      category: "Textiles",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-muted py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Decor</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Unique art pieces and decorative items to transform your space
            </p>
          </motion.div>
        </div>
      </section>
